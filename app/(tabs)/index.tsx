import {
  ...
  ScrollView,
  TextInput,
} from "react-native"; // React Native har et innebygget komponentbibliotek. For å ta i bruk komponentene må de importeres.
import { Link, Stack } from "expo-router"; // Dette er import av Link-komponenten til Expo-biblioteket, som gjør det mulig å linke til fil-lokasjonen til modalen jeg valgte å lage.

export default function Index() {
  // Når man lager en side i React Native må man lage en funksjon som kan eksporteres.

  return (
    // Det som vises på skjermen din skrives inne i feltet return.
    ...
    Hvis du ønsker at feks en overskrift skal være sticky/ikke scrolle med resten av innholdet, legges denne koden utenfor ScrollView i sin egen View som wrapper hele teksten i return-feltet */}
      <View style={styles.container}>
        ...
        <Image
          style={styles.image}
          source={require("@/assets/images/rodion-kutsaiev-0VGG7cqTwCo-unsplash.jpg")}
        />
        ...
        <Image
          style={styles.image}
          source={{
            uri: "https://plus.unsplash.com/premium_photo-1661877737564-3dfd7282efcb?q=80&w=2100&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
          }}
        />
